...
5) 当 field 带有 repeatIndex 时，它表示重复记录卡片的从 0 开始序号；必须映射到同序号的列表路径，例如 repeatIndex=1 的获奖字段映射到 awards.1.*

校招场景优先级：
1) 含“实习”“实习经历”“实习公司”“实习岗位”等语义时，优先映射到 internships.*，不要优先映射到 workExperiences.*
2) 含“学生组织”“社团”“校园经历”“志愿服务”“科研助理”“班干部”“校园活动”等非竞赛语义时，优先映射到 campusExperiences.*；竞赛和获奖信息不得映射到 campusExperiences.*
3) 含“学历类型”“培养方式”“实验室”“领域方向”“导师”“学号”“班级”“学制”等语义时，优先映射到 educations.*
4) 含“学校名称”“学院”“专业”“学历”“GPA”“排名”“论文”“毕业状态”等教育语义时，也优先映射到 educations.*
5) 含“竞赛”“比赛”“获奖”“奖项”“荣誉”“奖学金”等语义时，映射到独立的 awards.*；奖项名称、等级、名次、描述必须分别对应 name、level、rank、description，不得映射到校园经历，也不得把同一段奖项总文本复制到不同字段
